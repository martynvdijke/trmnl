...
PLUGINS = {
    ...
    "paperless-ngx": ("document", "#45A15E", "Paperless-ngx"),
...
def glyph(kind: str, stroke: str) -> str:
    ...
    shapes = {
        ...
        "document": '<path d="M18 10h20l8 8v36H18z"/><path d="M38 10v8h8"/><path d="M25 30h14M25 38h14M25 46h9"/>',
        "eye": '<path d="M10 32c6-9 13-13 22-13s16 4 22 13c-6 9-13 13-22 13s-16-4-22-13z"/><circle cx="32" cy="32" r="6"/>',
        "heartbeat": '<path d="M10 34h10l5-15 9 27 6-18 4 6h10"/>',
        "home": '<path d="M14 30L32 14l18 16"/><path d="M20 28v20h24V28"/><path d="M28 48V36h8v12"/>',
